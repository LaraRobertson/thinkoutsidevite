...
import {Map} from "../../Map";
import {ExampleGame} from "../../ui/UIComponents.tsx";
        ...
        <View className="game-details-content">
            ...
            <Accordion.Container allowMultiple defaultValue={['logistics']}>
                <Accordion.Item value="layout">
                    ...
                    <Accordion.Content>
                        <div><strong>About Game below:</strong><br />
                            <strong>This Game has 2 Zones</strong> - click on zone 2 for more puzzles and clues<br />
                        The image shows the center of zone 1 and the description helps you find it<br />
                            <strong>click on Puzzle</strong> to see what the questions are<br />
                        <strong>click on all the Clues</strong> to help solve the Puzzle<br />
                        if you need a hint - click on hint<br />
                        <strong>You must solve all the puzzles to win!
                        </strong></div>
                        <ExampleGame />
                    </Accordion.Content>
                </Accordion.Item>
