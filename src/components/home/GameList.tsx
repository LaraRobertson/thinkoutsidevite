...
export default function GameList(props: GameListProps) {
    ...
    return (
        <View id="game-list">
            ...
            <View className={gameLocationCity ? "dark-background-link" : "green-background-link"}
                  margin="10px auto 5px auto" textAlign="center" fontSize=".7em" padding="5px" lineHeight="1.1em">
            ...
            {(gameListByCity.length > 0) && (
                <View>
                    <View className={gameLocationPlace ? "dark-background-link" : "green-background-link"}
                          margin="10px auto 5px auto" textAlign="center" fontSize=".7em" padding="5px"
                          lineHeight="1.1em">
